    ...
    <div className="flex items-center justify-center md:w-120">
      ...
      {user ? (
        <div className="text-center">
          <p className="text-4xl md:text-5xl font-bold py-10 text-primary">
            ...
            <fieldset className="fieldset">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  type="button"
                  className="absolute z-10 right-3 top-3 text-base-content"
                >
                  {showPassword ? (
                    <IoIosEyeOff size={18} />
                  ) : (
              ...
              <div onClick={handleForgetPassword} className="">
                <a className="link link-hover text-[15px] text-base-content :text-[#4ade80]">
                  Forgot password?
                </a>
              </div>
